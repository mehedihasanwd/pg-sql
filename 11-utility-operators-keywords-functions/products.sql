...
SELECT product_name, weight, GREATEST(150, 2 * weight)
FROM products;

SELECT GREATEST(100, 500, 1000);
SELECT LEAST(100, 500, 1000);

SELECT product_name, price, LEAST(50, price * 1.5)
FROM products;

SELECT
  product_name, price,
  CASE
    WHEN price > 130 THEN 'most_expensive'
    WHEN price * 2 > 80 THEN 'medium'
    ELSE 'cheap'
  END
