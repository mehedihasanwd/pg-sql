...
SELECT
  *
FROM
  products ORDER BY price, weight;
...
SELECT
  *
FROM
  products ORDER BY product_name;

SELECT
  *
FROM
  products ORDER BY product_name DESC;
